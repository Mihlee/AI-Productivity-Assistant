...
export const BUSINESSES: Business[] = [
  {
    id: "biz-fade",
    slug: "lumina-hair-studio",
    name: "Lumina Hair Studio",
    category: "Grooming",
    tagline: "Women's cuts, colour and treatments — late slots on Thursdays.",
    about:
      "A three-chair ladies' salon focused on precision cuts, balayage and bond-repair treatments. Two senior stylists on shift most days, one on Mondays.",
    city: "Braamfontein",
    initials: "LH",
    aiStatus: "live",
    hours: [
    ...
    policies: [
      ...
      "Colour services require a patch test 48 hours before the appointment.",
    ],
    services: [
      {
        id: "svc-fade-1",
        name: "Cut & blow-dry",
        description: "Consultation, precision cut and styled blow-dry finish.",
        price: "R320",
        duration: "60 min",
      },
      {
        id: "svc-fade-2",
        name: "Root touch-up",
        description: "Regrowth colour application with gloss finish.",
        price: "R480",
        duration: "90 min",
      },
      {
        id: "svc-fade-3",
        name: "Balayage & toner",
        description: "Freehand lightening with toner and styled finish.",
        price: "R1 250",
        duration: "3 hrs",
        availabilityNote: "Balayage slots only start before 15:00.",
      },
      {
        id: "svc-fade-4",
        name: "Bond-repair treatment",
        description: "Deep-conditioning bond treatment with steam.",
        price: "R280",
        duration: "40 min",
      },
    ],
